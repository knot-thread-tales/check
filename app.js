...
async function submitOrder(e) {
  ...
  const display = formatPrice(p.offer_price || p.price);
...
async function openPaymentModal() {
  ...
  if (qrImg) {
    qrImg.src = ps.qr_image
      ...
      : `https://api.qrserver.com/v1/create-qr-code/?size=240x240&data=upi://pay?pa=${encodeURIComponent(ps.upi_id)}&pn=${encodeURIComponent(ps.merchant_name)}`;
  }
